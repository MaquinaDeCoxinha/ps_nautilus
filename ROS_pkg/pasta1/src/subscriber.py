...
def callback(data):
    msg = Modulo()
    pub_modulo = rospy.Publisher('chatter', Modulo, queue_size=10)
    ...
    rospy.loginfo(rospy.get_caller_id() + " modulo da velocidade linear = %s\n" % msg.modulo_ang)
    rospy.loginfo(rospy.get_caller_id() + " modulo da velocidade angular = %s\n" % msg.modulo_lin)
